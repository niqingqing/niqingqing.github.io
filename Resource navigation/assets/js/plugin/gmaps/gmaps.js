...
!function (e, t) {
    ...
    var t, o, n, i, r = function (e, t) {
        ...
        var o, n = Array.prototype.slice.call(arguments, 2), i = [], r = e.length;
        ...
        }); else for (o = 0; o < r; o++) callback_params = n, callback_params.splice(0, 0, e[o]), i.push(t.apply(this, callback_params));
        return i
    }, a = function (e) {
        var t, o = [];
        ...
        var n, i = function (e, t) {
            ...
            g = e.el || e.div, h = e.markerClusterer, d = google.maps.MapTypeId[e.mapType.toUpperCase()],
            u = new google.maps.LatLng(e.lat, e.lng), m = i(e.zoomControl, !0),
            ...
            x = {zoom: this.zoom, center: u, mapTypeId: d}, C = {
                panControl: w,
                zoomControl: m,
            ...
            if (p("gmaps_context_menu")) {
                ...
                var h = function (e) {
                    ...
                    if (e.getBoundingClientRect) {
                        var n = e.getBoundingClientRect(), i = -(window.scrollX ? window.scrollX : window.pageXOffset),
                    ...
                    return [t, o]
                }.apply(this, [s.el]), d = h[0] + t.pixel.x - 15, u = h[1] + t.pixel.y - 15;
        ...
        this.buildContextMenu = function (e, t) {
            if ("marker" === e) {
                ...
                o.setMap(s.map), o.draw = function () {
                    var n = o.getProjection(), i = t.marker.getPosition();
            ...
            for (o in e.options) if (e.options.hasOwnProperty(o)) {
                var i = e.options[o];
                window.context_menu[s.el.id][e.control][i.name] = {title: i.title, action: i.action}
            }
    ...
    return c.prototype.createControl = function (e) {
        ...
        var t = this, o = e.details, n = e.fences, i = e.outside,
            s = {position: new google.maps.LatLng(e.lat, e.lng), map: null}, a = r(s, e);
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function () {
            ...
            var n, i, r = this.getPanes(), s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            ...
            var i = t.el, r = i.children[0], s = r.clientHeight, a = r.clientWidth;
        ...
        var t = [], o = e.path;
        if (o.length) if (void 0 === o[0][0]) t = o; else for (var n, i = 0; n = o[i]; i++) t.push(new google.maps.LatLng(n[0], n[1]));
        var r = {
            map: this.map,
            path: t,
        ...
        delete(e = r({map: this.map, center: new google.maps.LatLng(e.lat, e.lng)}, e)).lat, delete e.lng;
        ...
        var t = !1;
        e.hasOwnProperty("useGeoJSON") && (t = e.useGeoJSON), delete e.useGeoJSON, e = r({map: this.map}, e), 0 == t && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = a(s(e.paths, l, t)));
        ...
        var n = e, i = new google.maps.KmlLayer(t, n);
        ...
        var t = r({avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: []}, e);
        ...
        t.panel = n, t = r({map: this.map}, t), o = new google.maps.DirectionsRenderer(t), this.getRoutes({
            origin: e.origin,
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (t) {
                if (t.length > 0 && e.start && e.start(t[t.length - 1]), t.length > 0 && e.step) {
                    var o = t[t.length - 1];
                    if (o.legs.length > 0) for (var n, i = o.legs[0].steps, r = 0; n = i[r]; r++) n.step_number = r, e.step(n, o.legs[0].steps.length - 1)
                }
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step) {
                    var n = o[o.length - 1];
                    if (n.legs.length > 0) for (var i, r = n.legs[0].steps, s = 0; i = r[s]; s++) {
                        i.step_number = s;
                        var a = {
                            path: i.path,
                            strokeColor: e.strokeColor,
        ...
        }); else if (e.route && e.route.legs.length > 0) for (var o, n = e.route.legs[0].steps, i = 0; o = n[i]; i++) {
            o.step_number = i;
            var r = {
                path: o.path,
                strokeColor: e.strokeColor,
        ...
        if (r) for (d = 0; d < r.length; d++) {
            ...
            for (var m = 0; m < r[d].stylers.length; m++) for (var f in r[d].stylers[m]) {
        ...
        for (var o = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = r({visible: !0}, e), i = 0; i < o.length; i++) delete n[o[i]];
        ...
        if (-1 == c.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2)); else if (e in o.registered_events) for (var n = o.registered_events[e], i = 0; i < n.length; i++) r = n[i].handler, s = o, a = t, r.apply(s, [a]);
        var r, s, a
        ...
        for (var o = !1, n = this.getPaths().getLength(), i = 0; i < n; i++) for (var r = this.getPaths().getAt(i), s = r.getLength(), a = s - 1, l = 0; l < s; l++) {
            var p = r.getAt(l), c = r.getAt(a);
